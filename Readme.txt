=== Little Hippo ===
Contributors: erbuc, benjaminspowell, Cornelis-DSA
...
Yes of course, please contact us to discuss how we can help! enquires@dosa.io
...
= 1.1.5 =
* No longer check for a minimum length on meta data
* Removed Post Revisions and Auto save settings configuration
* Fixed various errors and bugs when no data was present
...
* Added language - Serbo-Croatian by Borisa Djuraskovic (http://www.webhostinghub.com/)

...
class Tipp_Admin {
	...
	public static function hippo_init(){
		/**
		 * Put any initialization functions here.
		 **/
	}
	...
	public function add_charcount(){
		...
		<style>table.cmb_metabox input[type=text], table.cmb_metabox textarea {	width: 95%; }
		.form-table td span.seo-meta-desc, .form-table td span.seo-meta-title {vertical-align:top;font-size:10px;padding:6px 0 0 6px;font-weight:400;line-height:2.6;color: #555;}
		</style>';
	}

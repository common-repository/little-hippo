 ...
 * @copyright 2016 DSA Co Ltd & Eric Buckley
 */
			...
			<div class="tab-content">
				<div class="tab-pane fade in active" id="meta">
					<div class="issue_data <?php echo ($meta_issues['title_length'] > 0) ? 'issue_warning': 'issue_ok'; ?>">
						<h4><a href="<?php echo admin_url('admin.php?page=hippo_issues&type=title_length'); ?>"><?php echo $meta_issues['title_length'] . " " . __('items have a meta title that is too long', $this->plugin_slug); ?></a></h4>
						<div class="issue_details"><?php _e("Search results limit the number of characters they display for page titles. It’s considered best practice to keep page titles to 55 characters.", $this->plugin_slug); ?></div>
					</div>
					...
					<div class="issue_data <?php echo ($meta_issues['desc_length'] > 0) ? 'issue_warning': 'issue_ok'; ?>">
						<h4><a href="<?php echo admin_url('admin.php?page=hippo_issues&type=desc_length'); ?>"><?php echo $meta_issues['desc_length'] . " " . __('items have a meta description that is too long', $this->plugin_slug); ?></a></h4>
						<div class="issue_details"><?php _e("Search results limit the number of characters they display for meta descriptions. It’s considered best practice to keep meta descriptions to a maximum 155 characters.", $this->plugin_slug); ?></div>
					</div>
				...
				<div class="tab-pane fade" id="images">
					<div class="issue_data <?php echo ($img_issues['img_title_length'] > 0) ? 'issue_warning': 'issue_ok'; ?>">
						...
						<div class="issue_details"><?php _e("While there are no requirements for the number of characters for image titles we suggest that you keep image titles to a less than 65 characters.", $this->plugin_slug); ?></div>
					</div>
					...
					<div class="issue_data <?php echo ($img_issues['img_alt_length'] > 0) ? 'issue_warning': 'issue_ok'; ?>">
						<h4><a href="<?php echo admin_url('admin.php?page=hippo_issues&type=img_alt_length'); ?>"><?php echo $img_issues['img_alt_length'] . " " . __('images have an alt tag that is too long', $this->plugin_slug); ?></a></h4>
